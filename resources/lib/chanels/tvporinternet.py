...
from codequick import Route, Listitem, Resolver, utils, Script
import requests
import re
import base64
...
url_constructor = utils.urljoin_partial("https://www.tvporinternet2.com/")


@Route.register
def listItemsTvPorInternet(plugin):    
